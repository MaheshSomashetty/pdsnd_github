...
def get_city():
    ...
    Arg:
        none
    Returns:
        (str) Filename for the city's bike share data.
    '''
    city = ''
...
def get_day():
    ...
    Args:
        none
    Returns:
        (tuple) Lower limit, upper limit of dtae for the bikeshare data.
    '''
...
def statistics():
    ...
    #increase the column width so that the long strings in the 'journey'
